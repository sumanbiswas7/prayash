    ...
    <footer className="footer">
      <div className="container">
        ...
        >
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
              ...
              <div>
                ...
                <div className="bn" style={{ fontSize: 12, opacity: 0.7 }}>
                  আমরা থাকবো আগামীর স্বপ্নে
                </div>
              </div>
            </div>
            <p style={{ opacity: 0.72, maxWidth: 340, fontSize: 14 }}>
          ...
          <div>
            <div className="eyebrow" style={{ color: 'rgba(255,255,255,0.5)', marginBottom: 14 }}>
              Explore
            </div>
            <div className="stack" style={{ '--gap': '10px' } as React.CSSProperties}>
              <div>
                <a onClick={() => setPage('events')} style={{ cursor: 'pointer' }}>
                  Events
                </a>
              </div>
              <div>
              ...
              <div>
                <a onClick={() => setPage('gallery')} style={{ cursor: 'pointer' }}>
                  Gallery
                </a>
              </div>
              <div>
                <a onClick={() => setPage('dashboard')} style={{ cursor: 'pointer' }}>
                  Dashboard
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <div
              className="stack"
              style={{ '--gap': '10px', fontSize: 14, opacity: 0.8 } as React.CSSProperties}
            >
