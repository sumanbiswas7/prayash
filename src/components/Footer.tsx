          ...
          <div>
            <div className="footer__brand">
              ...
              <div>
                ...
                <div className="footer__brand-tagline bn">মানবকল্যাণ সংগঠন</div>
            ...
            <div className="footer__social">
              <a
                href="https://www.facebook.com/share/1HeRBxQvbT/?mibextid=wwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/proyaas.tehatta?igsh=MThzd3RpbmNzZDg0aA=="
                target="_blank"
                rel="noopener noreferrer"
                className="footer__social-link"
