...
export const PRAYASH_DATA: PrayashData = {
  events: [
    ...
    },
    {
      ...
      bn: 'অঙ্কন',
      color: 'orange',
      desc: 'On-the-spot drawing on a theme announced at the venue.',
    ...
    },
    {
      ...
      bn: 'সঙ্গীত',
      color: 'teal',
      desc: 'Rabindra sangeet, folk or modern — one song per entry.',
      slots: ['Under 10', 'Under 14', 'Open'],
      duration: '4 min / entry',
      format: 'Solo, harmonium allowed',
    },
    {
      id: 'handwriting',
      en: 'Handwriting',
      bn: 'হস্তাক্ষর',
      color: 'green',
      desc: 'A passage is dictated — neatness and legibility judged.',
      slots: ['Class I–III', 'Class IV–VI', 'Class VII–IX'],
      duration: '30 min',
      format: 'Pen & paper provided',
    },
    {
      id: 'debate',
      en: 'Debate',
    ...
    },
    {
      id: 'spelling',
      en: 'Spelling Bee',
      bn: 'বানান প্রতিযোগিতা',
      color: 'orange',
      desc: 'Spelling in Bengali and English — elimination rounds.',
      slots: ['Class III–V', 'Class VI–VIII'],
      duration: '60 min',
      format: 'Oral elimination',
    },
    {
      id: 'math',
      en: 'Mental Math',
      bn: 'মানসিক অঙ্ক',
      color: 'red',
      desc: 'Quick arithmetic and reasoning — no calculator.',
      slots: ['Class III–V', 'Class VI–VIII'],
      duration: '40 min',
      format: 'MCQ',
    },
    {
      ...
      bn: 'হস্তশিল্প',
      color: 'teal',
      desc: 'Bring a finished craft piece — judged on originality.',
      slots: ['Class I–V', 'Class VI–X'],
      duration: 'Showcase',
      format: 'Bring your work',
    },
  ],
  ...
  testimonials: [
    {
      q: "The books I got from Prayash last year helped me clear my board exams. This year I'm volunteering too.",
      who: 'Riya Das',
      where: 'Class XI · Tehatta',
      tone: 'teal',
    },
    {
      q: 'My daughter won Bronze in Abriti and now she recites at our village functions. Prayash gave her a stage.',
      who: 'Subhra Biswas',
      where: 'Parent · Karimpur',
      tone: 'purple',
    },
    {
      q: 'We donated 60 books from our home library. They went to a school we never knew existed, 20km away.',
      who: 'Anirban Ghosh',
      where: 'Donor · Kolkata',
      tone: 'blue',
    },
