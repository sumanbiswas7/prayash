  ...
  events: [
    {
      ...
      slots: ['বাচ্চােদর কুইজ (বিভাগ- ক)', 'সর্ব সাধারণ (বিভাগ- খ)'],
      duration: ['60 min', '60 min'],
      format: 'Group of 2 per team (Stage)',
      // format: 'বাছাই পর্ব (Written), চূড়ান্ত পর্ব (Rapid round)',
    },
    {
      id: 'drawing',
      en: 'Drawing',
      ...
      slots: ['বিভাগ- ক', 'বিভাগ- খ', 'বিভাগ- গ'],
      duration: ['60 min', '90 min', '90 min'],
      format: 'Art Papers will be provided',
    },
    {
      id: 'abriti',
      en: 'Abriti',
      bn: 'আবৃত্তি',
      color: 'red',
      desc: 'Poetry recitation from our prescribed anthology.',
      slots: ['বিভাগ- ক', 'বিভাগ- খ', 'বিভাগ- গ'],
